...
public class Vehiculo {
     ...
     */
    public Vehiculo(String codigo, String marca, int cambios, int velMaxima, int modelo, double cilindraje,TipoTransmision tipoTransmision, EstadoVehiculo estadoVehiculo) {
        this.codigo = codigo;
        this.marca = marca;
